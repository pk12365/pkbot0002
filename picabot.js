...
bot.on("message", function(message) {
    ...
    if (command === "kick") {
        ...
        if (kickUser.kickable && kickUser.highestRole.comparePositionTo(message.guild.member(bot.user).highestRole) <-1) return message.channel.send("my role is either the same or lower than the user you wish to kick.");
