...
bot.on("message", function(message) {
    ...
    if (command === "help") {
        ...
        message.channel.send("please check your dms", {replay: message}).then(message=> message.delete({timeout: 500}));
    }
    /*----------------------------------------------------------------------------------------------------------------
                                                UNTIL COMMANDS
    ------------------------------------------------------------------------------------------------------------------*/
...
/*    if (command === "leaveserver") {
    ...
    ----------------------------------------------------------------------------------------------------------------------*/
    if (command === "invite") {
        message.chennal.send("Invite URL: https://discordapp.com/oauth2/authorize?client_id=376292306233458688&scope=bot").then(message=> message.delete({timeout: 500}));
    }
