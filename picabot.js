...
bot.on("message", function(message) {
    ...
    if (command === "info") {
        ...
        .addField("Devloped by PK#1650",true)
        .addField(`Try with ${prefix}help`,true)
        .addField("SERVING-",false)
        .addField("Totel Guilds",`${bot.guilds.size}` + "Totel Channels",`${bot.channels.size}`,false)
        .addField("Totel Text Channels",`${TextChannels}` + "Totel Voice Channels",`${VoiceChannels}`,true)
        .addField("Totel Users",`${bot.users.size}`,false)
        .addField("support server",`[link](https://discord.gg/zFDvBay)` + "bot invite link",`[invite](https://discordapp.com/oauth2/authorize?client_id=376292306233458688&scope=bot)`,true)
    ...
    if (command === "serverinfo") {
        ...
        .addField ("Server Owner:", `${serverowner}`,tr)
