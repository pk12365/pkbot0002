...
bot.on("message", function(message) {
    ...
    if (command === "info") {
        ...
        .addField("SERVING-")
        .addField("Totel Guilds",`${bot.guilds.size}`,true + "Totel Channels",`${bot.channels.size}`,true)
        .addField("Totel Text Channels",`${TextChannels}`,true + "Totel Voice Channels",`${VoiceChannels}`,true)
        .addField("Totel Users",`${bot.users.size}`)
        .addField("support server",`[link](https://discord.gg/zFDvBay)`,true + "bot invite link",`[invite](https://discordapp.com/oauth2/authorize?client_id=376292306233458688&scope=bot)`,true)
